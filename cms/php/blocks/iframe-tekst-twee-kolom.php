...
if($_POST['opslaan'] == 1 && $_POST['blockTaal'] == 'true') {
    ...
    $tekstTweeCol = getBlockTranslation('tekst', $_POST['taal'], $rowBlockData['id'], '', $_POST['cmsid']);
}
