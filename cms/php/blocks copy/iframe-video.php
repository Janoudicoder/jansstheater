...
if($taal != 'nl') {
    ...
    $videoCode = getBlockTranslation('tekst', $taal, $rowBlockData['id'], '', $cms_id);
        ...
        <form action="<?php echo $PHP_SELF ?>?blockid=<?=$block_id;?>&taal=<?=$taal;?>&cmsid=<?=$cms_id;?>" method="post" enctype="multipart/form-data">
            <div class="content-container no-border-top mt-0 mb-30 pb-30 float-left">
                <div class="form-group">
                    <label for="tekst">Video code</label>
                    <input type="text" name="tekst" class="inputveld invoer" placeholder="" value="<?php echo $videoCode; ?>" />
                </div>
                <div class="form-group">
