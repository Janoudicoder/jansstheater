<div id="topmenu" class="flex justify-end">
    ...
    <div class="top-cta flex flex-col items-end hidden-1117">
    <div id="info" class="infotopmenu flex flex-col w-[254px] h-[76px] bg-primary text-white p-4 relative items-end slanted-edge">
    ...
    <a href="mailto:<?=$site_email;?>"><?=$site_email;?></a>
     ...
     <div id="socialmediatopmenu" class="flex bg-secondary p-4 slanted-edge-socialmedia " style="width: 167px; justify-content: end;">
         <a href="https://www.facebook.com/jansstheaterlochem/" target="_blank">
        ...
        <a href="https://x.com/jansstheater" target="_blank">
          <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 33px">
